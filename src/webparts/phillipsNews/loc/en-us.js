define([], function() {
  return {
    "PropertyPaneDescription": "Configure which news items this section shows and where they come from.",
    "ContentGroupName": "Content",
    "AdvancedGroupName": "Advanced",
    "DataSourceFieldLabel": "Data source",
    "DataSourceListLabel": "News Repository list",
    ...
    "SourceSiteUrlFieldLabel": "Source site URL",
